...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Jan 25, 2002
#
# Extension code to tcl8.3/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.3.4.2 Win32/INTEL, Fri Jan 25 08:37:37 Pacific Standard Time 2002
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1011976657}
	buildtime,fmt {Fri Jan 25 08:37:37 Pacific Standard Time 2002}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.3.4.2 Win32/INTEL, Fri Jan 25 08:37:37 Pacific Standard Time 2002 / normal}
    }
}

package provide {ActiveTcl} {8.3.4.2}
